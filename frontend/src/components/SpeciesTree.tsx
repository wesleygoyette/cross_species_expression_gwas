          ...
          <div className="space-y-4">
            <Card className="p-6 bg-card border-border">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-[#00d4ff]">20,439</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Regulatory Elements</p>
                  <p className="text-[#00d4ff]">1,547,892</p>
                </div>
                <div>
            ...
            <Card className="p-6 bg-card border-border">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Genes</p>
                  <p className="text-[#00ff88]">21,962</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Regulatory Elements</p>
                  <p className="text-[#00ff88]">1,234,567</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Orthologous Genes</p>
                  <p className="text-[#00ff88]">17,345</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Genome Assembly</p>
            ...
            <Card className="p-6 bg-card border-border">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Genes</p>
                  <p className="text-[#ff8c42]">20,587</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Regulatory Elements</p>
                  <p className="text-[#ff8c42]">1,123,456</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Orthologous Genes</p>
                  <p className="text-[#ff8c42]">16,892</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs mb-1">Genome Assembly</p>
